...
public class RateUlocResource {
    ...
    public ResponseEntity<ApiResponse<PageResponse<RateUlocAdminView>>> findAllDrafts(
            ...
            @RequestParam(name = "cvpCodeId", required = false) Long cvpCodeId,
    ...
    @Operation(summary = "Approve and activate draft", 
            description = "Approves a ULOC rate draft and moves it to the Active table in ONE step. " +
    ...
    public ResponseEntity<ApiResponse<List<RateUlocAdminView>>> findAllByCvpCodeAndAmountTier(
            ...
            @RequestParam(name = "cvpCodeId") Long cvpCodeId,
