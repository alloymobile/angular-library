...
public class CvpCodeService {
    ...
    public CvpCodeAdminView create(CvpCodeInput input) {
        log.info("Creating new CVP code with name: {}", input.getName());
        ...
        log.info("CVP Code created successfully with id: {}", entity.getId());
    ...
    public CvpCodeAdminView update(Long id, CvpCodeInput input) {
        log.info("Updating CVP code with id: {}", id);
        ...
        log.info("CVP Code updated successfully with id: {}", entity.getId());
        return mapper.toAdminView(entity);
    }
    
    @Transactional
    public void delete(Long id) {
        log.info("Soft deleting CVP code with id: {}", id);
        ...
        log.info("CVP Code soft deleted successfully with id: {}", id);
    }
    
    @Transactional
    public CvpCodeAdminView reactivate(Long id) {
        log.info("Reactivating CVP code with id: {}", id);
        ...
        log.info("CVP Code reactivated successfully with id: {}", id);
        return mapper.toAdminView(entity);
    }
