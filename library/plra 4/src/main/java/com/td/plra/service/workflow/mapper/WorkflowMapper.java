...
public interface WorkflowMapper {
    ...
    @Mapping(target = "rateStatus", source = "toStatus")
    @Mapping(target = "changeBy", ignore = true)
    @Mapping(target = "changeOn", ignore = true)
    ...
    @Mapping(target = "updatedOn", ignore = true)
    @Mapping(target = "version", ignore = true)
    void updateEntity(WorkflowInput input, @MappingTarget Workflow entity);
}
