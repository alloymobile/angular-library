...
import { of } from 'rxjs';
import { AdminIlocRatesComponent } from './admin-iloc-rates';
...
describe('AdminIlocRatesComponent', () => {
  let component: AdminIlocRatesComponent;
  let fixture: ComponentFixture<AdminIlocRatesComponent>;
  let api: ReturnType<typeof createMockApi>;

  beforeEach(async () => {
    api = createMockApi();
    await TestBed.configureTestingModule({
      imports: [AdminIlocRatesComponent, FormsModule],
      providers: [
    ...
    fixture = TestBed.createComponent(AdminIlocRatesComponent);
