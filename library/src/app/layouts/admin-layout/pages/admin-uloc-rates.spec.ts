...
import { of } from 'rxjs';
import { AdminUlocRatesComponent } from './admin-uloc-rates';
...
describe('AdminUlocRatesComponent', () => {
  let component: AdminUlocRatesComponent;
  let fixture: ComponentFixture<AdminUlocRatesComponent>;
  let api: ReturnType<typeof createMockApi>;

  beforeEach(async () => {
    api = createMockApi();
    await TestBed.configureTestingModule({
      imports: [AdminUlocRatesComponent, FormsModule],
      providers: [
    ...
    fixture = TestBed.createComponent(AdminUlocRatesComponent);
