...
import { of } from 'rxjs';
import { SuperAdminIlocRatesComponent } from './super-admin-iloc-rates';
import { TranslationService } from '../../../core/i18n/translation.service';
import { RateApiService } from '../../../core/services/rate-api.service';
import { MockTranslationService, MOCK_TIERS, MOCK_SUBCATEGORIES, MOCK_ILOC_ACTIVE, MOCK_ILOC_DRAFTS, MOCK_WORKFLOWS, mockPage } from '../../../testing/mock-data';
...
function createMockApi() {
  return {
    ...
    getIlocDrafts: jest.fn().mockReturnValue(of(mockPage(MOCK_ILOC_DRAFTS))),
    getIlocHistory: jest.fn().mockReturnValue(of(mockPage([]))),
    getWorkflows: jest.fn().mockReturnValue(of(mockPage(MOCK_WORKFLOWS))),
    createIlocDraft: jest.fn().mockReturnValue(of({ id: 9001 })),
    updateIlocDraft: jest.fn().mockReturnValue(of({ id: 2001 })),
    submitIlocDraft: jest.fn().mockReturnValue(of({ id: 2001 })),
    approveIlocDraft: jest.fn().mockReturnValue(of({ id: 3001 })),
    rejectIlocDraft: jest.fn().mockReturnValue(of({ id: 3001 })),
  };
}

describe('SuperAdminIlocRatesComponent', () => {
  let component: SuperAdminIlocRatesComponent;
  let fixture: ComponentFixture<SuperAdminIlocRatesComponent>;
  let api: ReturnType<typeof createMockApi>;

  beforeEach(async () => {
    api = createMockApi();
    await TestBed.configureTestingModule({
      imports: [SuperAdminIlocRatesComponent, FormsModule],
      providers: [
    ...
    fixture = TestBed.createComponent(SuperAdminIlocRatesComponent);
  ...
  it('should call getIlocActive', () => { expect(api.getIlocActive).toHaveBeenCalled(); });
  it('should set productName', () => { expect(component.productName).toBe('ILOC'); });
