...
/**
 * QRateUlocDraft is a Querydsl query type for RateUlocDraft
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QRateUlocDraft extends EntityPathBase<RateUlocDraft> {

    private static final long serialVersionUID = 1781598956L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRateUlocDraft rateUlocDraft = new QRateUlocDraft("rateUlocDraft");
    ...
    public QRateUlocDraft(String variable) {
        this(RateUlocDraft.class, forVariable(variable), INITS);
    }

    public QRateUlocDraft(Path<? extends RateUlocDraft> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QRateUlocDraft(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QRateUlocDraft(PathMetadata metadata, PathInits inits) {
        this(RateUlocDraft.class, metadata, inits);
    }

    public QRateUlocDraft(Class<? extends RateUlocDraft> type, PathMetadata metadata, PathInits inits) {
