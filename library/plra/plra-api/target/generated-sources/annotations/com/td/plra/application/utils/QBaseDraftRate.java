...
/**
 * QBaseDraftRate is a Querydsl query type for BaseDraftRate
 */
@Generated("com.querydsl.codegen.DefaultSupertypeSerializer")
public class QBaseDraftRate extends EntityPathBase<BaseDraftRate> {

    private static final long serialVersionUID = 642298531L;

    public static final QBaseDraftRate baseDraftRate = new QBaseDraftRate("baseDraftRate");
    ...
    public QBaseDraftRate(String variable) {
        super(BaseDraftRate.class, forVariable(variable));
    }

    public QBaseDraftRate(Path<? extends BaseDraftRate> path) {
        super(path.getType(), path.getMetadata());
    }

    public QBaseDraftRate(PathMetadata metadata) {
        super(BaseDraftRate.class, metadata);
    }
