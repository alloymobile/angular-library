...
public interface WorkflowRepository extends JpaRepository<Workflow, Long>, QuerydslPredicateExecutor<Workflow> {
    ...
    List<Workflow> findByRateType(RateType rateType);
    ...
    List<Workflow> findByRateTypeAndRateIdOrderByChangeOnDesc(RateType rateType, Long rateId);

    List<Workflow> findByChangeId(Long changeId);
}
