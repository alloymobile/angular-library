 ...
 * </pre>
 * Every state transition generates a NEW changeId to satisfy UK_WORKFLOW unique constraint.
 * </p>
 */
@Slf4j
@Service
...
public class RateUlocService {
    ...
    public RateUlocAdminView approve(Long draftId, String message) {
        ...
        if (activeCount == 0) {
            ...
            workflowService.recordTransition(
                    RateType.ULOC, expiredRate.getId(), archiveChangeId,
        ...
        workflowService.recordTransition(
                RateType.ULOC, newActive.getId(), approveChangeId,
    ...
    public void expireRate(Long activeId) {
        ...
        workflowService.recordTransition(
                RateType.ULOC, activeRate.getId(), expireChangeId,
