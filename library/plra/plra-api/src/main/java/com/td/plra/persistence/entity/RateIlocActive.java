...
/**
 * ILOC Rate Active entity - UK FK lifecycle.
 * ID is NOT auto-generated; it is manually set from Draft.ID.
 * DB FK: RATE_ILOC_ACTIVE.ID → RATE_ILOC_DRAFT.ID
 */
@Data
@EqualsAndHashCode(callSuper = true)
@Entity
@Table(name = "RATE_ILOC_ACTIVE")
@EntityListeners(AuditingEntityListener.class)
public class RateIlocActive extends BaseRate {
