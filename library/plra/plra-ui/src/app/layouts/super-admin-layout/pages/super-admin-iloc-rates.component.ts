...
@Component({
  ...
  template: `
    <header class="mb-3">
      <h2 class="page-heading"><i class="fa-solid fa-table-cells-large text-td-green me-2"></i>ILOC — Rate Management</h2>
      <p class="page-subtitle">SubCategory × Amount Tier — full lifecycle: enter, submit, approve, audit</p>
    </header>
