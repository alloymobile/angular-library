...
@Component({
  ...
  template: `
    <header class="mb-3">
      <h2 class="page-heading"><i class="fa-solid fa-table-cells text-td-green me-2"></i>ULOC — Rate Management</h2>
      <p class="page-subtitle">CVP Code × Amount Tier — full lifecycle: enter, submit, approve, audit</p>
    </header>
