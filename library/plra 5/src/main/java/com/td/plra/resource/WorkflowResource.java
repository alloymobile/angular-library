...
public class WorkflowResource {
    ...
    public ResponseEntity<ApiResponse<PageResponse<WorkflowAdminView>>> findAll(
            @Parameter(description = "Global search across changeId, changeBy (case-insensitive)")
            ...
            @RequestParam(name = "rateStatus", required = false) String rateStatus,
            ...
            @RequestParam(name = "rateId", required = false) Long rateId,
            ...
            @RequestParam(name = "changeBy", required = false) String changeBy,
            @Parameter(description = "Change date from (yyyy-MM-dd)")
            @RequestParam(name = "changeFrom", required = false) String changeFrom,
            @Parameter(description = "Change date to (yyyy-MM-dd)")
            @RequestParam(name = "changeTo", required = false) String changeTo,
