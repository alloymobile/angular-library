...
/**
 * Entity class for VW_ULOC_CURRENT_RATES view.
 * Currently valid ULOC rates with full hierarchy.
 * This is a read-only entity mapped to a database view.
 */
@Entity
@Immutable
@Table(name = "VW_ULOC_CURRENT_RATES", schema = "RATEMGMT")
public class VwUlocCurrentRates implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        VwUlocCurrentRates that = (VwUlocCurrentRates) o;
