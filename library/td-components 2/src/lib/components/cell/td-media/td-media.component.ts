// src/lib/components/cell/td-media/td-media.component.ts
...
import { TdLinkComponent } from '../td-link/td-link.component';
...
@Component({
  ...
  templateUrl: './td-media.component.html',
  styleUrls: ['./td-media.component.css']
})
