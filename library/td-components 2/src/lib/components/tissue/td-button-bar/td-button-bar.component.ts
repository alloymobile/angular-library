// src/lib/components/tissue/td-button-bar/td-button-bar.component.ts

import { Component, Input, Output, EventEmitter, OnInit, OnChanges, SimpleChanges } from '@angular/core';
import { CommonModule } from '@angular/common';
import { ButtonBarObject } from './td-button-bar.model';
import { TdButtonComponent } from '../../cell/td-button/td-button.component';
import { TdButtonIconComponent } from '../../cell/td-button-icon/td-button-icon.component';
...
@Component({
  ...
  templateUrl: './td-button-bar.component.html',
  styleUrls: ['./td-button-bar.component.css']
})
