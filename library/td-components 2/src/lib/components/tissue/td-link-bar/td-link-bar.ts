// src/lib/components/tissue/td-link-bar/td-link-bar.ts

import { Component, Input, OnInit, OnChanges, SimpleChanges } from '@angular/core';
import { CommonModule } from '@angular/common';
import { LinkBarObject, cloneWithActiveAndClick } from './td-link-bar.model';
import { TdLinkComponent } from '../../cell/td-link/td-link';
import { TdLinkIconComponent } from '../../cell/td-link-icon/td-link-icon';
