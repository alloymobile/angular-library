// src/lib/components/tissue/td-card-action/td-card-action.component.ts
import { Component, Input, Output, EventEmitter, OnInit, OnChanges, SimpleChanges } from '@angular/core';
import { CommonModule } from '@angular/common';
import { CardActionObject } from './td-card-action.model';
import { TdCardComponent } from '../td-card/td-card.component';
import { TdButtonBarComponent } from '../td-button-bar/td-button-bar.component';

@Component({
  selector: 'td-card-action',
  standalone: true,
  imports: [CommonModule, TdCardComponent, TdButtonBarComponent],
  templateUrl: './td-card-action.component.html',
  styleUrls: ['./td-card-action.component.css']
})
