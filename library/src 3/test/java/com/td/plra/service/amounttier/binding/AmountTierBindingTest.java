...
@DisplayName("AmountTierBinding predicate builder")
class AmountTierBindingTest {

    private final AmountTierBinding binding = new AmountTierBinding();
    ...
    @Test
    void shouldIncludeMinMaxFiltersWhenProvided() {
        Map<String, String> params = new HashMap<>();
        params.put("minAmount", "1000");
        params.put("maxAmount", "5000");
        BooleanExpression predicate = binding.buildPredicate(params);
        assertThat(predicate).isNotNull();
        assertThat(predicate.toString()).contains("min").contains("max");
    }
}
